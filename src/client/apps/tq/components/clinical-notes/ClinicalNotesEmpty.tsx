...
export const ClinicalNotesEmpty: React.FC<ClinicalNotesEmptyProps> = ({
  hasQuery = false,
  query = ''
}) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-2">
        {hasQuery ? t('clinical_notes.empty.not_found') : t('clinical_notes.empty.no_notes')}
      </h3>

      <p className="text-gray-600 text-center max-w-md">
        {hasQuery
          ? t('clinical_notes.empty.no_match', { query })
