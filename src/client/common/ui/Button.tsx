  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        tertiary: "text-purple-600 bg-white border border-purple-300 hover:bg-purple-50 focus:ring-purple-500 active:scale-[0.98]",
        ghost: "hover:bg-gray-100 hover:text-gray-900 active:scale-[0.98]",
        link: "text-gray-900 underline-offset-4 hover:underline",
      },
      size: {
        default: "h-8 px-4 py-2 text-[0.9375rem]",
        sm: "h-9 px-3 text-sm",
        lg: "h-11 px-8 text-base",
        icon: "h-10 w-10 text-[0.9375rem]",
      },
    },
    defaultVariants: {
      variant: "primary",
