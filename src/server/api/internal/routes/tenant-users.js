...
router.get('/debug/routes', (req, res) => {
  res.json({
    ...
    availableRoutes: [
      'GET /tenants/users (with tenantId filter)',
...
// Removed: GET /tenants/:tenantId/users (duplicated with GET /tenants/users)
// Use GET /tenants/users with tenantId query parameter instead
...
// Moved: GET /tenants/users route moved to tenants.js to avoid route conflict with /:id
